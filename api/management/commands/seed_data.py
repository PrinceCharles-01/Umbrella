...
class Command(BaseCommand):
    help = 'Seeds the database with initial pharmacy and medication data.'
    ...
    def handle(self, *args, **options):
        ...
        pharmacies_data = [
            ...
            },
            {
                ...
                'latitude': 0.3925, # Approximatif
                'longitude': 9.4534, # Approximatif
                'note': 4.0,
        ...
        # Fetch created objects to link them
